			...
			<td>
				<table width="400" align=center border=0>
					<tr>
						...
						<hr>
					<tr>
						<td align=center width=100>A(150元/個):<td align=center>${P.getA() }份
					<tr>
						<td align=center width=100>B(120元/個):<td align=center>${P.getB() }份
					<tr>
						<td align=center width=100>C(100元/個):<td align=center>${P.getC() }份
					<tr>
						<td colspan=2>
						<hr>
					<tr>
